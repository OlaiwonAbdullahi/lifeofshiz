          ...
          <div className="flex items-start w-full mt-[10px]">
            <ul className="mr-[80px]">
              <li className="cursor-pointer">
                <PiTiktokLogoLight className="w-[30px] h-[30px] my-[10px]" />
              </li>
              <li className="cursor-pointer">
                <PiInstagramLogo className="w-[30px] h-[30px] my-[10px]" />
              </li>
              <li className="cursor-pointer">
                <PiPinterestLogoBold className="w-[30px] h-[30px] my-[10px]" />
              </li>
            </ul>
            <ul>
              <li className="cursor-pointer">
                <PiYoutubeLogo className="w-[30px] h-[30px] my-[10px]" />
              </li>
              <li className="cursor-pointer">
                <PiTwitterLogo className="w-[30px] h-[30px] my-[10px]" />
              </li>
              <li className="cursor-pointer">
                <PiFacebookLogo className="w-[30px] h-[30px] my-[10px]" />
              </li>
            </ul>
          </div>
        </div>
