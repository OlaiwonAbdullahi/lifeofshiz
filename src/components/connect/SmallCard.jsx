...
function SmallCard() {
  ...
  return (
    <div className="absolute left-[5%] bottom-5 w-[90%] sm:w-[70%] md:w-[40%] h-[70%] p-6  flex flex-col items-center justify-start">
      ...
      <button
        className="  mt-6 flex items-center gap-2.5 cursor-pointer bg-[#6b4c2d] text-[#e3dcdc] px-6 py-3 rounded-md text-center justify-center font-Montserrat hover:bg-[#695f4d] transition-all duration-300"
